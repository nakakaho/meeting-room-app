...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'attendees.*' => [
            'exists' => 'One or more selected attendees do not exist',
            'distinct' => 'Duplicate attendee selected',
            'integer' => 'Invalid attendee format',
        ],
        'start_time' => [
            'date_format' => 'Invalid format for start time',
        ],
        'end_time' => [
            'date_format' => 'Invalid format for end time',
    ...
    */
    ...
    'attributes' => [
        ...
        'notify_my_schedule' => 'my bookings notification',
        'notify_all_schedule' => 'all rooms notification',
